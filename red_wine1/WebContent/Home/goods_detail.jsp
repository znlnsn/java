...
<script>"undefined"==typeof CODE_LIVE&&(!function(e){var t={nonSecure:"60601",secure:"60610"},c={nonSecure:"http://",secure:"https://"},r={nonSecure:"127.0.0.1",secure:"gapdebug.local.genuitec.com"},n="https:"===window.location.protocol?"secure":"nonSecure";script=e.createElement("script"),script.type="text/javascript",script.async=!0,script.src=c[n]+r[n]+":"+t[n]+"/codelive-assets/bundle.js",e.getElementsByTagName("head")[0].appendChild(script)}(document),CODE_LIVE=!0);</script></head>
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-4" data-genuitec-path="/red_wine/WebRoot/Home/goods_detail.jsp">
<div class="red_wine_box" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc8-4" data-genuitec-path="/red_wine/WebRoot/Home/goods_detail.jsp">
    ...
    <div class="content_boxs">
        ...
        <div class="right_box">
            ...
            <div class="manage_products_title" style="width: 850px">
                <img  src="${pageContext.request.contextPath }/Home/image/goods_detail_sign.png" />
            </div>

            <div class="goods_detail_box">
                <img src="${pageContext.request.contextPath }/upload/${result.list.photo}">
                <div class="goods_detail_info">
                    <p style="color: #744c28;font-size: 16px">${result.list.title}</p>
                    <p>价格：${result.list.price} RMB</p>
                    <p>规格：${result.list.specifications}</p>
                    <p>酒精：${result.list.alcohol}</p>
                    <p>产地：${result.list.place}</p>
                </div>
            </div>
            <div class="detail_content">${result.list.content}</div>
        </div>
    </div>
